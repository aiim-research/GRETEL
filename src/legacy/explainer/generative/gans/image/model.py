...
class GAN(BaseGAN):
    ...
    def check_configuration(self):
        dflt_generator = 'src.legacy.explainer.generative.gans.image.generators.ResGenerator'
        dflt_discriminator = 'src.legacy.explainer.generative.gans.image.discriminators.SimpleDiscriminator'
