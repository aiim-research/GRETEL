...
class EdgeLearnableGAN(BaseGAN):
    ...
    def check_configuration(self):
        dflt_generator = "src.explainer.generative.gans.graph.learnable_edges.TranslatingGenerator"
        dflt_discriminator =  "src.explainer.generative.gans.graph.learnable_edges.discriminators.EmbeddingDiscriminator" #"src.explainer.generative.gans.graph.discriminators.SimpleDiscriminator"
        dflt_pre_descriminator = "src.explainer.generative.gans.graph.learnable_edges.graph_embedders.PreDiscriminatorEmbedder"
        ...
        init_dflts_to_of(self.local_config,
                         ...
                         dropout=dropout,
                         dim=out_embed_dim)  
        # Check if the pre_descriminator exists or build with its defaults:
        init_dflts_to_of(self.local_config,
                         'pre_discriminator',
                         dflt_pre_descriminator,
                         num_nodes=self.dataset.num_nodes,
