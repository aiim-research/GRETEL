...
class SubexGED(SubexMetricStage):
    ...
    def process(self, explanation: Explanation) -> Explanation:
        ...
        input_inst_lbl = subex.oracle.predict(input_inst)
        ...
        for cf in subex.counterfactual_instances:
            ...
            cf_lbl = subex.oracle.predict(cf)
            subex.oracle._call_counter -= 1
        ...
        # Writing the metric value into the explanation instead of the subexplanation
